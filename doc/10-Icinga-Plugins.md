...
| ---         | --- |
| [Invoke-IcingaCheckIISHealth](plugins/01-Invoke-IcingaCheckIISHealth.md) | Checks the installation status of the IIS feature and the status of the IIS service. |
| [Invoke-IcingaCheckIISAppPoolHealth](plugins/02-Invoke-IcingaCheckIISAppPoolHealth.md) | This plugin will check the health and resource usage of IIS Application Pools. |
